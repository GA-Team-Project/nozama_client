...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://afternoon-coast-29423.herokuapp.com',
...
var onGetOrders = function onGetOrders() {
  api.getOrders().then(ui.getOrdersSuccess).then(function () {
    var cartLength = store.userData.cart.items.length;
...
var updateOrder = function updateOrder(data, id) {
  return $.ajax({
...
var deleteOrder = function deleteOrder(itemId) {
  return $.ajax({
...
var checkoutTemplate = __webpack_require__(18);
var showOrdersTemplate = __webpack_require__(35);
var store = __webpack_require__(1);
var orderHistory = store.userData.orders;
...
var getOrdersSuccess = function getOrdersSuccess(data) {
  var current_user = store.user._id;
...
var onShowPastOrders = function onShowPastOrders() {
...
var showCart = function showCart() {
  // Checkout Form Logic
  var cart = store.userData.cart;
  // console.log(cart)
  // console.log(cart._id)
  var sameItemsInSart = 0;
  var nozamaItems = store.items;
  $('.content').html(checkoutTemplate);

  cart.items.forEach(function (item) {
    var itemPrice = void 0,
        itemName = void 0;
    nozamaItems.filter(function (obj) {
    ...
    var markup = '<tr><td> ' + itemName + ' </td> <td> ' + itemQty + ' </td> <td> $' + itemPrice + '.00 </td> </tr>';
    $('tbody').append(markup);
  });
  var total = parseInt(cart.total) / 100.00;
...
module.exports = {
  ...
  onShowPastOrders: onShowPastOrders,
  clearCart: clearCart,
  showCart: showCart,
  failure: failure
};
...
var itemEvents = __webpack_require__(36);
var userEvents = __webpack_require__(40);
var orderEvents = __webpack_require__(6);
...
var onSignUp = function onSignUp(event) {
  ...
  var data = getFormFields(this); // this === event.target 
  // console.log(data)
...
var onSignOut = function onSignOut(event) {
  ...
  api.signOut().then(ui.signOutSuccess).then().catch(ui.failure);
};
...
var store = __webpack_require__(1);
var ordersEvents = __webpack_require__(6);

var clearMessage = function clearMessage(id) {
  // console.log(id)
  id.html('');
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"cart-template\">\n  <h1>Your Cart</h1>\n  <hr>\n  <BR />\n  <table>\n    <thead>\n      <tr>\n        <th>Item Name</th>\n        <th>Item Qty</th>\n        <th>Item price</th>\n      </tr>\n    </thead>\n    <tbody></tbody>\n  </table>\n\n  <div>\n    <h3 id=\"total\"></h3>\n    <div class=\"stripe\">\n      <form id=\"stripe-form\" action=\"/charge\" method=\"POST\">\n        <input id=\"stripe-input\" type='hidden' name='headers[Authorization]' />\n        <script src=\"https://checkout.stripe.com/checkout.js\" class=\"stripe-button\" data-key=\"pk_test_I14scEAR7GUQqoFGFTTdriYt\" data-name=\"Stripe.com\"\n          data-image=\"https://stripe.com/img/documentation/checkout/marketplace.png\" data-locale=\"auto\" data-zip-code=\"true\">\n          </script>\n      </form>\n    </div>\n    <button class=\"btn btn-warning\" id=\"remove-item\">Cancel Order</button>\n  </div>\n</div>";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.orders : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
  ...
  return "    <div class=\"thumbnail\">\n      <div class=\"caption\">\n        <h3>Order ID: "
    ...
    + "</p>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.items : stack1),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "        <p><b>Total:</b> $"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.total : stack1), depth0))
    + "</p>\n        <h3>Submitted: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.submitted : stack1), depth0))
    + "</h3>\n      </div>\n    </div>  \n";
  ...
  return "        <p><b>Item:</b> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "</p>\n        <p><b>Item ID:</b> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.item_id : stack1), depth0))
    + "</p>\n        <p><b>Quantity:</b> "
  ...
  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.orders : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(5, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
var onGetItems = function onGetItems(event) {
  event.preventDefault();
  api.getItems().then(ui.getItemsSuccess).catch(ui.failure);
};
...
var showItemsTemplate = __webpack_require__(39);
var store = __webpack_require__(1);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div class=\"col-sm-6 col-md-3 item-image\">\n    <div class=\"thumbnail\">\n      <img src="
    ...
    + "g</li>\n            <li><b>Dimensions:</b> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.dimensions : stack1), depth0))
    + "</li>\n            <li>\n              <button class=\"btn btn-warning addToCart\" role=\"button\" id=\"addToCart\">Sign in to shop</button>\n            </li>\n          </ul>\n      </div>\n    </div>\n  </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
var ordersAPI = __webpack_require__(7);
var config = __webpack_require__(3);
...
var addToCart = function addToCart(event) {
    ...
    var orderTotal = 0;
    var target = $(event.target).parents('ul').attr('data-id');
    var itemPrice = $(event.target).parents('ul').attr('data-price');
    var item = void 0,
        newOrder = void 0,
        data = void 0,
        items = [];
    ...
    item = {
        ...
        // Is the cart empty?
    };!cart.hasOwnProperty('owner') ? function () {
        ...
        ordersAPI.createOrder(data).then(ui.createOrderSuccess).catch(console.error());
    }() : function () {
        ...
        ordersAPI.updateOrder(data, store.userData.order_id).then(ui.updateOrderSucces);
    }();
};
...
var deleteItem = function deleteItem(event) {
    ...
    // console.log(orderId)
    ordersAPI.deleteOrder(orderId).then(ordersUI.clearCart).then(ordersUI.showCart).catch(ordersUI.failure);
};

var userHandlers = function userHandlers() {
...
var createOrderSuccess = function createOrderSuccess(data) {
    ...
    var newNumber = parseInt(badge.text()) + 1;
    badge.text(newNumber);
};

var updateOrderSucces = function updateOrderSucces(data) {
    var newNumber = parseInt(badge.text()) + 1;
    badge.text(newNumber);
...
module.exports = {
    createOrderSuccess: createOrderSuccess,
    updateOrderSucces: updateOrderSucces
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
